...
app = QApplication([])
main_window = QWidget()
main_window.setWindowTitle("Image App")
...
class Editor():
    ...
    def load_image(self, filename):
        ...
        full_name = os.path.join(working_directory, self.filename)
...
def display_image():
    if file_list.currentRow() >= 0:
        ...
        main_editor.load_image(filename)
        main_editor.show_image(os.path.join(working_directory, main_editor.filename))



main_editor = Editor()

btn_folder.clicked.connect(get_work_dir)
file_list.currentRowChanged.connect(display_image)
gray.clicked.connect(main_editor.gray)
btn_left.clicked.connect(main_editor.left)
btn_right.clicked.connect(main_editor.right)
mirror.clicked.connect(main_editor.mirror)
sharpness.clicked.connect(main_editor.sharpness)
blur.clicked.connect(main_editor.blur)
saturation.clicked.connect(main_editor.saturation)
contrast.clicked.connect(main_editor.contrast)
