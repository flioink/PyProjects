...
class App(tk.Tk):
    ...
    def create_small_layout(self):
        ...
        self.frame = ttk.Frame(self)
        ttk.Label(self.frame, text="Label 1", background="teal").pack(expand=True, fill="both", padx=10, pady=5)
    ...
    def create_medium_layout(self):
        ...
        ttk.Label(self.frame, text="Label 1", background="teal").grid(column=0, row=0, sticky="nsew", padx=10, pady=10)
