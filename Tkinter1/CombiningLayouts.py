...
# ttk.Label(menu_frame, text="Label 1", background="gray").pack(expand=True, fill="both")
# ttk.Label(main_frame, text="Label 2", background="green").pack(expand=True, fill="both")
