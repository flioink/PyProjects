...
class Menu(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        menu_slider1.grid(row=2, column=0, rowspan=2, sticky="nse", pady=20)
        menu_slider2.grid(row=2, column=2, rowspan=2, sticky="nse", pady=20)
...
class Main(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        Entry(self, "Label 2", "Button 2", "purple")
