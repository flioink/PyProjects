...
class Plant(pygame.sprite.Sprite):
    def __init__(self, plant_type, groups, soil, check_watered):
        ...
        self.frames = import_folder(f"resources/graphics/fruit/{plant_type}")
        self.soil = soil
...
class SoilLayer:
    def __init__(self, all_sprites, collision_sprites):
        ...
        # graphics
        self.soil_surf = pygame.image.load("resources/graphics/soil/o.png")
        # self.grid = None
        self.create_soil_grid()
        # self.hit_rects = None
        self.create_hit_rects()
        self.soil_surfs = import_folder_dict("resources/graphics/soil/")
        self.water_surfs = import_folder("resources/graphics/soil_water")

        # sounds
        self.hoe_sound = pygame.mixer.Sound("resources/audio/hoe.wav")
        self.hoe_sound.set_volume(0.1)
        self.plant_sound = pygame.mixer.Sound("resources/audio/plant.wav")
        self.plant_sound.set_volume(0.2)

    def create_soil_grid(self):
        ground = pygame.image.load("resources/graphics/world/ground.png")
        h_tiles, v_tiles = ground.get_width() // TILE_SIZE, ground.get_height() // TILE_SIZE
        # print(h_tiles, v_tiles)
        self.grid = [[[] for col in range(h_tiles)] for row in range(v_tiles)]
        for x, y, _ in load_pygame("resources/data/map.tmx").get_layer_by_name("Farmable").tiles():
