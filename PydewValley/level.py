...
class Level:
    def __init__(self):
        ...
        # music
        self.success = pygame.mixer.Sound("resources/audio/success.wav")
        self.success.set_volume(0.3)
        # self.music = pygame.mixer.Sound("resources/audio/music.mp3")

    def setup(self):
        tmx_data = load_pygame("resources/data/map.tmx")
        # house
        ...
        ground_path = r"resources\graphics\world\ground.png"
        Generic(pos=(0, 0),
